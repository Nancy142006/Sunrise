      ...
      <div className="flex ml-[50px] flex-col space-y-10">
        <div>
          ...
          <div className="flex space-x-[2rem] items-start space-y-[-30px]">
            ...
            <div className="bg-[#fef3c7] w-[40rem] h-[38rem] rounded-2xl px-8 py-6 font-sans text-[14px] leading-relaxed text-center mx-auto space-y-2">
              ...
              <div className="text-gray-800 space-y-2">
                ...
                <p>
                  ...
                  <br />
                  <span className="text-12">Business Insider</span>
                  <br />
